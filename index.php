<!DOCTYPE html>
  <head>
    ...
    <!-- Bootstrap -->
    <link href="wp-content/themes/Will/css/bootstrap.min.css" rel="stylesheet">
    <link href="wp-content/themes/Will/css/font-awesome.min.css" rel="stylesheet">
    <link rel="stylesheet" href="wp-content/themes/Will/css/templatemo_misc.css">
    <link href="wp-content/themes/Will/style.css" rel="stylesheet">
    <link href='http://fonts.googleapis.com/css?family=Raleway:400,100,600' rel='stylesheet' type='text/css'>
      
    <script src="wp-content/themes/Will/js/jquery-1.10.2.min.js"></script> 
	<script src="wp-content/themes/Will/js/jquery.lightbox.js"></script>
	<script src="wp-content/themes/Will/js/templatemo_custom.js"></script>
    <script>
    function showhide()
    {
  ...
  <body>
			...
			<div class="container">
				<div class="row templatemo_gallerygap">
                    ...
                    <div class="col-md-3 col-sm-12">
                    	<a href="#"><img src="wp-content/themes/Will/images/templatemo_logo.jpg" alt="Polygon HTML5 Template"></a>
                    </div>
    	...
    	<div>
          <div class="hexagon hexagon2 gallery-item">
            <div class="hexagon-in1">
              <div class="hexagon-in2" style="background-image: url(wp-content/themes/Will/images/gallery/1.jpg);">
             	 	<div class="overlay">
    ...
    <div class="hex col-sm-6">
    	<div>
          <div class="hexagon hexagon2 gallery-item">
            <div class="hexagon-in1">
              <div class="hexagon-in2" style="background-image: url(wp-content/themes/Will/images/gallery/2.jpg);">
              	<div class="overlay">
    ...
    <div class="hex col-sm-6  templatemo-hex-top2">
    	<div>
          <div class="hexagon hexagon2 gallery-item">
            <div class="hexagon-in1">
              <div class="hexagon-in2" style="background-image: url(wp-content/themes/Will/images/gallery/3.jpg);">
              	<div class="overlay">
    ...
    <div class="hex col-sm-6  templatemo-hex-top3">
    	<div>
          <div class="hexagon hexagon2 gallery-item">
            <div class="hexagon-in1">
              <div class="hexagon-in2" style="background-image: url(wp-content/themes/Will/images/gallery/4.jpg);">
              	<div class="overlay">
    ...
    <div class="hex col-sm-6  templatemo-hex-top3">
    	<div>
          <div class="hexagon hexagon2 gallery-item">
            <div class="hexagon-in1">
              <div class="hexagon-in2" style="background-image: url(wp-content/themes/Will/images/gallery/5.jpg);">
              		<div class="overlay">
    	...
    	<div>
          <div class="hexagon hexagon2 gallery-item">
            <div class="hexagon-in1">
              <div class="hexagon-in2" style="background-image: url(wp-content/themes/Will/images/gallery/6.jpg);">
              		<div class="overlay">
     ...
     <div class="hex col-sm-6 templatemo-hex-top1 templatemo-hex-top3">
    	<div>
          <div class="hexagon hexagon2 gallery-item">
            <div class="hexagon-in1">
              <div class="hexagon-in2" style="background-image: url(wp-content/themes/Will/images/gallery/7.jpg);">
              		<div class="overlay">
      ...
      <div class="hex col-sm-6 templatemo-hex-top1  templatemo-hex-top3">
          ...
          <div class="hexagon hexagon2 gallery-item">
            <div class="hexagon-in1">
              <div class="hexagon-in2" style="background-image: url(wp-content/themes/Will/images/gallery/8.jpg);">
              		<div class="overlay">
      ...
      <div class="hex col-sm-6 templatemo-hex-top1  templatemo-hex-top2">
          ...
          <div class="hexagon hexagon2 gallery-item">
            <div class="hexagon-in1">
              <div class="hexagon-in2" style="background-image: url(wp-content/themes/Will/images/gallery/9.jpg);">
              		<div class="overlay">
    ...
    <div  id="newpost" style="display:none;" class="container answer_list templatemo_gallerytop">
    	...
    	<div>
          <div class="hexagon hexagon2 gallery-item">
            <div class="hexagon-in1">
              <div class="hexagon-in2" style="background-image: url(wp-content/themes/Will/images/gallery/10.jpg);">
             	 	<div class="overlay">
    ...
    <div class="hex col-sm-6">
    	<div>
          <div class="hexagon hexagon2 gallery-item">
            <div class="hexagon-in1">
              <div class="hexagon-in2" style="background-image: url(wp-content/themes/Will/images/gallery/11.jpg);">
              	<div class="overlay">
    ...
    <div class="hex col-sm-6  templatemo-hex-top2">
    	<div>
          <div class="hexagon hexagon2 gallery-item">
            <div class="hexagon-in1">
              <div class="hexagon-in2" style="background-image: url(wp-content/themes/Will/images/gallery/12.jpg);">
              	<div class="overlay">
    ...
    <div class="hex col-sm-6  templatemo-hex-top3">
    	<div>
          <div class="hexagon hexagon2 gallery-item">
            <div class="hexagon-in1">
              <div class="hexagon-in2" style="background-image: url(wp-content/themes/Will/images/gallery/13.jpg);">
              	<div class="overlay">
    ...
    <div class="hex col-sm-6  templatemo-hex-top3">
    	<div>
          <div class="hexagon hexagon2 gallery-item">
            <div class="hexagon-in1">
              <div class="hexagon-in2" style="background-image: url(wp-content/themes/Will/images/gallery/14.jpg);">
              		<div class="overlay">
    	...
    	<div>
          <div class="hexagon hexagon2 gallery-item">
            <div class="hexagon-in1">
              <div class="hexagon-in2" style="background-image: url(wp-content/themes/Will/images/gallery/15.jpg);">
              		<div class="overlay">
     ...
     <div class="hex col-sm-6 templatemo-hex-top1 templatemo-hex-top3">
    	<div>
          <div class="hexagon hexagon2 gallery-item">
            <div class="hexagon-in1">
              <div class="hexagon-in2" style="background-image: url(wp-content/themes/Will/images/gallery/16.jpg);">
              		<div class="overlay">
      ...
      <div class="hex col-sm-6 templatemo-hex-top1  templatemo-hex-top3">
          ...
          <div class="hexagon hexagon2 gallery-item">
            <div class="hexagon-in1">
              <div class="hexagon-in2" style="background-image: url(wp-content/themes/Will/images/gallery/17.jpg);">
              		<div class="overlay">
      ...
      <div class="hex col-sm-6 templatemo-hex-top1  templatemo-hex-top2">
          ...
          <div class="hexagon hexagon2 gallery-item">
            <div class="hexagon-in1">
              <div class="hexagon-in2" style="background-image: url(wp-content/themes/Will/images/gallery/18.jpg);">
              		<div class="overlay">
            	...
            	<div class="row">
                	<div class="col-md-3 col-sm-4">
                        	 <div class="hexagon hexagonteam gallery-item">
                               <div class="hexagon-in1">
                                <div class="hexagon-in2" style="background-image: url(wp-content/themes/Will/images/team/1.jpg);">
                    ...
                    <div class="col-md-3 col-sm-4">
                        	 <div class="hexagon hexagonteam gallery-item">
                               <div class="hexagon-in1">
                                <div class="hexagon-in2" style="background-image: url(wp-content/themes/Will/images/team/2.jpg);">
                                <div class="overlay templatemo_overlay1">
                                	<a href="#fb">
                                   	 <div class="smallhexagon">
                                  	 	 <span class="fa fa-facebook"></span>
            ...
            <div class="container templatemo_hexteam s_top">
            	<div class="row">
                	<div class="col-md-3 col-sm-4">
                        	 <div class="hexagon hexagonteam gallery-item">
                               <div class="hexagon-in1">
                                <div class="hexagon-in2" style="background-image: url(wp-content/themes/Will/images/team/3.jpg);">
                                <div class="overlay templatemo_overlay1">
                                	<a href="#fb">
                                   	 <div class="smallhexagon">
                                  	 	 <span class="fa fa-facebook"></span>
                    ...
                    <div class="col-md-3 col-sm-4">
                        	 <div class="hexagon hexagonteam gallery-item">
                               <div class="hexagon-in1">
                                <div class="hexagon-in2" style="background-image: url(wp-content/themes/Will/images/team/4.jpg);">
                                <div class="overlay templatemo_overlay1">
                                	<a href="#fb">
                                   	 <div class="smallhexagon">
                                  	 	 <span class="fa fa-facebook"></span>
